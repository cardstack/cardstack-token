...
const CST_DEPLOY_GAS_LIMIT = 5900000;
...
async function assertRevert(block, msg) {
  ...
  if (msg) {
    ...
    return assert.isOk(err.message.search("revert") > -1 ||
                       err.message.search("invalid opcode") > -1, // "throw" results in an invalid opcode in solidity > 0.4.10, TODO: need to update throw with revert...
