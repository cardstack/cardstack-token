...
contract('CardStackToken', function(accounts) {
  ...
  describe("contract upgrade - successor contract", function() {
    ...
    xit("allows purchase of CST for successor contract", async function() {
    });
    xit("allows selling of CST for successor contract", async function() {
    });
    xit("allows transfer of CST for successor contract", async function() {
    });
    xit("allows minting of CST for successor contract", async function() {
    });
    xit("allows granting of CST for successor contract", async function() {
    });
    xit("allows set buy and sell price of CST for successor contract", async function() {
    });
    xit("allows set sellCap of CST for successor contract", async function() {
    });
    xit("allows initialize() of CST for successor contract", async function() {
    });
    xit("allows initializeFromStorage() of CST for successor contract", async function() {
    });
    xit("allows updateLedgerStorage() of CST for successor contract", async function() {
    });
    xit("allows updateExternalStorage() of CST for successor contract", async function() {
    });
    xit("allows name() of CST for successor contract", async function() {
    });
    xit("allows symbol() of CST for successor contract", async function() {
    });
    xit("allows totalTokens() of CST for successor contract", async function() {
    });
    xit("allows totalInCirculation() of CST for successor contract", async function() {
    });
    xit("allows balanceOf() of CST for successor contract", async function() {
    });
  });
