...
contract('CardStackToken', function(accounts) {
  ...
  describe("buy()", function() {
    ...
    it("can not purchase more CST than has been minted", async function() {
      await ledger.mintTokens(10);
      await cst.initialize(web3.toHex("CardStack Token"), web3.toHex("CST"), web3.toWei(1, "ether"), web3.toWei(1, "ether"), 15, NULL_ADDRESS);
      let buyerAccount = accounts[1];
    ...
    it("can not purchase more CST than the CST sellCap", async function() {
      await ledger.mintTokens(10);
      await cst.initialize(web3.toHex("CardStack Token"), web3.toHex("CST"), web3.toWei(1, "ether"), web3.toWei(1, "ether"), 5, NULL_ADDRESS);
      let buyerAccount = accounts[1];
